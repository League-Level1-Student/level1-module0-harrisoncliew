...
public class BodyPartQuiz {
	...
	private void startQuiz() {
		...
		// -- Tell them they are wrong and who the person is
			...
			JOptionPane.showMessageDialog(null, "Incorrect. That was Arnold Schwarzenegger.");
		}
		...
		if( guess2.equalsIgnoreCase("Leonardo")) {
			...
			JOptionPane.showMessageDialog(null, "Incorrect. That was Leonardo DiCaprio.");
		}
		showNextImage();
		JOptionPane.showMessageDialog(null, "Your current score is "+score+".");
		...
		if(guess3.equalsIgnoreCase("Morgan")) {
			...
			JOptionPane.showMessageDialog(null, "That was Morgan Freeman.");
		}
		showNextImage();
		...
		if(guess4.equalsIgnoreCase("Jack")) {
			...
			JOptionPane.showMessageDialog(null, "Incorrect. That was Jack Black.");
		}
		JOptionPane.showMessageDialog(null, "Your final score is "+score+"/4.");
